		...
		<div class="w-100" id="cfooter">
			<table class="table">
				<tr>
					...
					<td width="10%">
						<button class="btn btn-primary" style="background-color: green; " type="button" onclick="$('#send_chat').submit()"><i class="fa fa-paper-plane" style="background-color: green;"></i></button>
					</td>
				</tr>
			</table>
...
<style>
	...
	#cheader{
		height: calc(10%);
		border-bottom: 3px solid #36383F;
		padding:1em .5em;
		background: #36383F;
		color:white;
